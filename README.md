...
Current focus: **Sprint 7.5b done (approval-gated progression + gated answer review) → Sprint 8 (certificates + PWA) + Sprint 9 Phase C-E (upload UI, update modes, source adapters)**
...
- [docs/sprint-7-5-content-coherence.md](docs/sprint-7-5-content-coherence.md) - Sprint 7.5: content coherence, onboarding + flow hardening (plan + status)
- [docs/sprint-7-5-content-coherence-report.md](docs/sprint-7-5-content-coherence-report.md) - Sprint 7.5: IRT on real content, auto-enroll, data-driven Profile/Settings, idempotent approvals
