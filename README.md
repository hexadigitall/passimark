...
Current focus: **Sprint 7.5 done (content coherence + onboarding + flow hardening) → Sprint 8 (certificates + PWA) + Sprint 9 Phase C-E (upload UI, update modes, source adapters)**
