...
class PassimarkQuestion extends Model {
    ...
    protected $fillable=['session_id','exam_id','external_id','content','options','correct_key','difficulty','discrimination','guessing','domain','bloom_level','explanation','reference'];
