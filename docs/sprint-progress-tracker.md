...
**Status:** Sprint 5 **done**, Sprint 6 **done** (7-8 planned)
**Evidence:** [sprint-5-v4-worldwide-catalog.md](sprint-5-v4-worldwide-catalog.md), [worldwide-catalog-sprint-5-report.md](worldwide-catalog-sprint-5-report.md), [sprint-6-irt-cat-engine.md](sprint-6-irt-cat-engine.md), [sprint-6-irt-cat-engine-report.md](sprint-6-irt-cat-engine-report.md), [v4-worldwide-catalog-spec.md](v4-worldwide-catalog-spec.md)
